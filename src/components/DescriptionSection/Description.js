          ...
          <div className="col-lg-6">
            ...
            <div className="description-section__text">
              <p>
                ...
                Offering, projects open their pre-sale funding rounds to $FLAME
                Token Holders.
              </p>
              <p>
                Powered by culture and community, the building blocks of the
                Metaverse and AI have now reached the blockchain. Own The
                Future.
              </p>
            </div>
          </div>
